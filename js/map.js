...
function loadInfoWindow(marker, infoWindow) {
	if (marker.html() === "pending search") {
		...
		var representative = marker.representative;
...
function getWikiData(districtArray) {
	var representative = districtArray.representative;
	...
	var infoContent = '<div id="content">'+'<div id="siteNotice">'+'</div>'+
	            '<h1 id="firstHeading" class="firstHeading">'+firstResponse+'</h1>'+'</div>';
	infoContent = $.parseHTML(infoContent)[0];
...
var getResponse = /*(response) {
	...
	infoContent = '<div id="content">'+'<div id="siteNotice">'+'</div>'+
	            '<h1 id="firstHeading" class="firstHeading">'+firstResponse+'</h1>'+'</div>';
	infoContent = $.parseHTML(infoContent)[0];
	    //console.log(infoContent);
	return infoContent;
